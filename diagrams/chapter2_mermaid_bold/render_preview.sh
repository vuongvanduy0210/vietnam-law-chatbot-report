...
OUT_DIR="$ROOT_DIR/Bao_Cao/sample_images/chapter2_mermaid_bold_preview"
PUPPETEER_CONFIG="$ROOT_DIR/Bao_Cao/diagrams/chapter2/puppeteer-config.json"
CSS_FILE="$SCRIPT_DIR/mermaid_bold.css"
...
echo "Rendered bold Mermaid previews to $OUT_DIR"
